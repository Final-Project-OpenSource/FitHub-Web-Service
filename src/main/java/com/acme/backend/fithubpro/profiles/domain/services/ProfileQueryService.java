...
import com.acme.backend.fithubpro.profiles.domain.model.queries.GetAllProfilesQuery;
import com.acme.backend.fithubpro.profiles.domain.model.queries.GetProfileByEmailQuery;
import com.acme.backend.fithubpro.profiles.domain.model.queries.GetProfileByIdQuery;
